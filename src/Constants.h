...
#define PBC_PARAM_FILE_PATH "./param/a.param" 	//the path of the PBC parameter file
#define GLOBAL_PARAM_FILE_PATH "./param/global_param_file" 	    //the path of the Global parameter file
